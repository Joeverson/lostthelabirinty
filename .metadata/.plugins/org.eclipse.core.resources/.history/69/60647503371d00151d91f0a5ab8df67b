...
public abstract class DAO<T> implements DAOInterface<T> {
	...
	public static void open(){
		if(manager==null){			
			...
			config.common().objectClass(Container.class).cascadeOnUpdate(true);
			config.common().objectClass(Container.class).cascadeOnDelete(true);
			config.common().objectClass(Container.class).cascadeOnActivate(true);
			config.common().objectClass(Warrior.class).cascadeOnUpdate(true);
			config.common().objectClass(Warrior.class).cascadeOnDelete(true);
			config.common().objectClass(Warrior.class).cascadeOnActivate(true);
			
			// 		indexacao de atributos
			config.common().objectClass(Warrior.class).objectField("name").indexed(true);
			config.common().objectClass(Monster.class).objectField("nome").indexed(true);
